    ...
    <div class="card has-table">
      <header class="card-header">
        <p class="card-header-title">
          <span class="icon"><i class="mdi mdi-message" id="button-ajouter"></i></span>
          Message
        </p>
        <!-- <a href="tables.php" class="card-header-icon">
          ...
          <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td><?= $student['nom']; ?></td>
                  <td><?= $student['email']; ?></td>
                  <td><?= $student['produit']; ?></td>
                  <td><?= $student['message']; ?></td>
                  <td>

                  <td><a href="voir-message.php?id=<?= $student['id']; ?>" class="button small green --jb-modal" id="button-voir">Voir</a> </td>
                  <!-- <a href="edit-message.php?id=<?= $student['id']; ?>" class="button small green --jb-modal">Modifier</a> -->
                  <td>
                    <form action="code-message.php" method="POST" class="d-inline">
