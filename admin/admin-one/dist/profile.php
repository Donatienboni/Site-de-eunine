  ...
  <div id="app">
    ...
    <div class="card has-table">
      <header class="card-header">
        ...
        <a href="ajouter-utilisateur.php" class="card-header-icon">
          ...
          <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td><a href="edit-utilisateur.php?id=<?= $student['id']; ?>" class="button small green --jb-modal" id="button-modifier">Modifier</a></td>
                  <td>
                    <form action="code-utilisateur.php" method="POST" class="d-inline">
