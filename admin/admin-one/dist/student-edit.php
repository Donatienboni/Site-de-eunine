                    ...
                    <div class="card-body">
                        ...
                        ?>
                                <form action="code.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label>nom produit</label>               <!-- variable 'description' qui est dans la DB   -->
                                        <input type="text" name="nom" value="<?= $student['nom']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>description</label>               <!-- variable 'description' qui est dans la DB   -->
                                        <input type="text" name="description" value="<?= $student['description']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>images</label>                   <!-- variable 'image' qui est dans la DB   -->
                                        <input type="file" name="course" value="<?= $student['image']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
